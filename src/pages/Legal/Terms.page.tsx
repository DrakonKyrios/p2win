      ...
      <SectionContentStyled>
        <div className="legal-body">
          <div>
            ...
            <div>
              <strong>
                <span className="heading_1">AGREEMENT TO OUR LEGAL TERMS</span>
              </strong>
            </div>
          </div>
          ...
          <div>
            <div className="body_text">
              We are Viewtech Labs LLC ("<strong>Company</strong>," "
              <strong>we</strong>," "<strong>us</strong>," "<strong>our</strong>
              "), a company registered in Delaware, United States at __________,
              Newark
              <span className="body_text">
                <span className="body_text">, DE 19711</span>
              </span>
              .
            </div>
          </div>
          ...
          <div>
            <div className="body_text">
              ...
              <a
                href="http://www.p2win.gg"
                target="_blank"
                className="link text-secondary-500"
              >
                http://www.p2win.gg
              </a>{" "}
            ...
            <div className="body_text">
              We provide analysis on how pay for content in individual video
              games alter the difficulty and competition between those who pay
              for content and those who do no pay for content.
            </div>

            <div className="body_text">
              You can contact us by email at support@viewtechlabs.com or by mail
              to __________, Newark, DE 19711,&nbsp;United States.
            </div>

            <div className="body_text">
              These Legal Terms constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity ("
              <strong>you</strong>"), and Viewtech Labs LLC, concerning your
          ...
          <div>
            ...
            <div>
              <a href="#services">
                <span className="link text-secondary-500">
                  <span className="body_text">1. OUR SERVICES</span>
                </span>
              </a>
            </div>
            <div>
              <a href="#ip" className="link text-secondary-500">
                <span className="body_text">
            ...
            <div>
              <a href="#userreps" className="link text-secondary-500">
                <span className="body_text">3. USER REPRESENTATIONS</span>
              </a>
            </div>

            <div>
              <a href="#prohibited" className="link text-secondary-500">
                <span className="body_text">4. PROHIBITED ACTIVITIES</span>
              </a>
            </div>
            <div>
              <a href="#ugc" className="link text-secondary-500">
                <span className="body_text">
            ...
            <div>
              <a href="#license" className="link text-secondary-500">
                <span className="body_text">6. CONTRIBUTION LICENSE</span>
              </a>
            </div>

            <div>
              <a href="#thirdparty" className="link text-secondary-500">
                <span className="body_text">
            ...
            <div>
              <a href="#advertisers" className="link text-secondary-500">
                <span className="body_text">8. ADVERTISERS</span>
              </a>
            </div>
            <div>
              <a href="#sitemanage" className="link text-secondary-500">
                <span className="body_text">9. SERVICES MANAGEMENT</span>
              </a>
            </div>
            <div>
              <a href="#ppyes" className="link text-secondary-500">
                <span className="body_text">10. PRIVACY POLICY</span>
              </a>
            </div>

            <div>
              <a href="#copyrightyes" className="link text-secondary-500">
                <span className="body_text">11. COPYRIGHT INFRINGEMENTS</span>
              </a>
            </div>
            <div>
              <a href="#terms" className="link text-secondary-500">
                <span className="body_text">12. TERM AND TERMINATION</span>
              </a>
            </div>
            <div>
              <a href="#modifications" className="link text-secondary-500">
                <span className="body_text">
            ...
            <div>
              <a href="#law" className="link text-secondary-500">
                <span className="body_text">14. GOVERNING LAW</span>
              </a>
            </div>
            <div>
              <a href="#disputes" className="link text-secondary-500">
                <span className="body_text">15. DISPUTE RESOLUTION</span>
              </a>
            </div>
            <div>
              <a href="#corrections" className="link text-secondary-500">
                <span className="body_text">16. CORRECTIONS</span>
              </a>
            </div>
            <div>
              <a href="#disclaimer" className="link text-secondary-500">
                <span className="body_text">17. DISCLAIMER</span>
              </a>
            </div>
            <div>
              <a href="#liability" className="link text-secondary-500">
                <span className="body_text">18. LIMITATIONS OF LIABILITY</span>
              </a>
            </div>
            <div>
              <a href="#indemnification" className="link text-secondary-500">
                <span className="body_text">19. INDEMNIFICATION</span>
              </a>
            </div>
            <div>
              <a href="#userdata" className="link text-secondary-500">
                <span className="body_text">20. USER DATA</span>
              </a>
            </div>
            <div>
              <a href="#electronic" className="link text-secondary-500">
                <span className="body_text">
            ...
            <div>
              <a href="#california" className="link text-secondary-500">
                <span className="body_text">
            ...
            <div>
              <a href="#misc" className="link text-secondary-500">
                <span className="body_text">23. MISCELLANEOUS</span>
              </a>
            </div>

            <div>
              <a href="#contact" className="link text-secondary-500">
                <span className="body_text">24. CONTACT US</span>
              </a>
            </div>
          </div>
          <div>
            <div id="services" className="heading_1">
          ...
          <div>
            ...
            <div className="body_text">
              ...
              Terms, please address your request to: support@viewtechlabs.com.
          ...
          <div>
            <div id="userreps" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>3.</strong>&nbsp;
          ...
          <div>
            <div className="body_text">
              ...
              permission to use the Services; (3) you will not access the
          ...
          <div>
            <div>
              ...
              <div>
                <div id="prohibited" className="heading_1">
                  <strong>
                    <strong>
                      <strong>
                        <strong>4.</strong>
              ...
              <div>
                  ...
                  <div>
                    ...
                    <ul>
                      ...
                      <li className="body_text">
                        ...
                        of the Services or modifies, impairs, disrupts, alters,
                      ...
                      <li className="body_text">
                        ...
                        formats ("gifs"), 1&times;1 pixels, web bugs, cookies,
                ...
                <div>
                  <div>
                    <div id="ugc" className="heading_1">
                      <strong>
                        <strong>
                          <strong>
                            <strong>5.</strong>
              ...
              <div>
                <div id="license" className="heading_1">
                  <strong>
                    <strong>
                      <strong>
                        <strong>6.</strong>
            ...
            <div id="thirdparty" className="heading_1">
              <strong>
                <strong>
                  <strong>7.</strong>
                </strong>
            ...
            <div id="advertisers" className="heading_1">
              <strong>
                <strong>
                  <strong>8.</strong>
                </strong>
            ...
            <div id="sitemanage" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>9.</strong>
            ...
            <div id="ppyes" className="heading_1">
              <strong>
                <strong>
                  <strong>10.</strong>
                </strong>
            ...
            <div className="body_text">
              ...
              <strong>
                &nbsp;
                <a
                  href="http://www.p2win.gg/privacy"
                  target="_blank"
                  className="link text-secondary-500"
                >
                  http://www.p2win.gg/privacy
                </a>
              </strong>
            ...
            <div id="copyrightyes" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>11.</strong>
            ...
            <div id="terms" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>12.</strong>
            ...
            <div id="modifications" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>13.</strong>
            ...
            <div id="law" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>14.</strong>
            ...
            <div id="disputes" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>15.</strong>
            ...
            <div className="body_text">
              ...
              applicable law, the arbitration will take place in New Castle
            ...
            <div className="body_text">
              ...
              the&nbsp;state and federal courts&nbsp;located in New Castle
              County,&nbsp;Delaware, and the Parties hereby consent to, and
            ...
            <div id="corrections" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>16.</strong>
            ...
            <div id="disclaimer" className="heading_1">
              <strong>
                <strong>
                  <strong>17.</strong>
                </strong>{" "}
            ...
            <div id="liability" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>18.</strong>
            ...
            <div id="indemnification" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>19.</strong>
            ...
            <div id="userdata" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>20.</strong>
            ...
            <div id="electronic" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>21.</strong>
            ...
            <div id="california" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>22.</strong>
            ...
            <div id="misc" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>23.</strong>
            ...
            <div id="contact" className="heading_1">
              <strong>
                <strong>
                  <strong>
                    <strong>24.</strong>
            ...
            <div className="body_text">
              <strong>Viewtech Labs LLC</strong>
            </div>
            <div className="body_text">
              <strong>Newark, DE 19711</strong>
            </div>
            <div className="body_text">
            ...
            <div className="body_text">
              <strong>
                <strong>support@viewtechlabs.com</strong>
              </strong>
            </div>
          </div>
        </div>
