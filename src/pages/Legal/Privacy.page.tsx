...
export default function PrivacyPolicy() {
  return (
    <SectionContainerStyled>
      <SectionContentStyled>
        <div className="article legal-body" id="content">
          <div id="placeholders">
            <h2>
            ...
            <p className="heading_1">
              Welcome to{" "}
              <span className="highlight preview_website_name">Pay-2-Win</span>!
            </p>
            <p>
            ...
            <p>
              ...
              a non-exclusive license to use, reproduce, edit and authorize
